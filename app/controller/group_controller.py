...
async def create_group(group: GroupCreate):
    ...
    # try:
    group = await group_service.create_group(group) #.create_group(validated_data)
...
async def update_group(id: int, group_update: GroupUpdate):
    ...
    try:
        group = await group_service.update_group(id, group_update) #.update_group(id, validated_data)
